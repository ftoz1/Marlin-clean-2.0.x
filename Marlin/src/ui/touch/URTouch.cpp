...
//	#include "hardware/avr/HW_AVR.inc"
  ...
  //	#include "hardware/pic32/HW_PIC32.inc"
	...
	#include "../hardware/arm/HW_ARM_touch.h"
#endif
...
void URTouch::setCAL(long calx, long caly, long cals, byte orientation)
{
    orient					= orientation;
...
void URTouch::InitTouch(byte orientation)
{
    ...
    setCAL(CAL_X, CAL_Y, CAL_S, orientation);
	prec					= 10;
